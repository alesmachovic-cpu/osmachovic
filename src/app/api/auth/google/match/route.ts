...
export async function POST(req: NextRequest) {
  ...
  // (Táto vetva beží len keď totp_enabled_at je null; inak vyššie vrátime requires_2fa.)
  res.headers.append("Set-Cookie", buildTwoFactorCookieValue(isAdminTier(users.role)));
  return res;
}
